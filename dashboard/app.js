...
function drawRiskChart(rows) {
  ...
  ctx.fillStyle = "#888";
  ctx.font = "12px "Source Sans Pro", "IBM Plex Sans", sans-serif";
  ...
  items.forEach(([label, count, color], index) => {
    ...
    ctx.font = "700 15px "Source Sans Pro", "IBM Plex Sans", sans-serif";
...
function drawScatterChart(rows) {
  ...
  sorted.forEach((row, index) => {
    ...
    if (index < 6) {
      ctx.fillStyle = "#888";
      ctx.font = "11px "Source Sans Pro", "IBM Plex Sans", sans-serif";
