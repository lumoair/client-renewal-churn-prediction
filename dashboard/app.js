...
const LOCALES = {
  en: {
    ...
    renewalDue30Desc: "Accounts approaching the renewal window",
    renewalDue60: "Renewal Due in 60d",
    renewalDue60Desc: "Near-term accounts to actively manage",
    renewalDue90: "Renewal Due in 90d",
    renewalDue90Desc: "Longer-range accounts to pre-wire",
  ...
  ar: {
    ...
    renewalDue30Desc: "الحسابات التي تقترب من نافذة التجديد",
    renewalDue60: "التجديد المستحق خلال 60 يوم",
    renewalDue60Desc: "حسابات قصيرة الأجل للإدارة النشطة",
    renewalDue90: "التجديد المستحق خلال 90 يوم",
    renewalDue90Desc: "حسابات طويلة الأجل للتحضير المسبق",
...
function drawRiskChart(rows) {
  ...
  ctx.fillStyle = "#888";
  ctx.font = "12px "Playfair Display", Georgia, "Times New Roman", serif";
  ...
  items.forEach(([label, count, color], index) => {
    ...
    ctx.font = "700 15px "Playfair Display", Georgia, "Times New Roman", serif";
...
function drawScatterChart(rows) {
  ...
  sorted.forEach((row, index) => {
    ...
    if (index < 6) {
      ctx.fillStyle = "#888";
      ctx.font = "11px "Playfair Display", Georgia, "Times New Roman", serif";
